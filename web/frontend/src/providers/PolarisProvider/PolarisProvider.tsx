...
import { getPolarisTranslations } from "@/utils/i18n";
import { ProviderProps, LinkProps } from "@/types";

interface AppBridgeLinkProps extends LinkProps {
  [key: string]: any;
}
 ...
 */
export function PolarisProvider({ children }: ProviderProps) {
